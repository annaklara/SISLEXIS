...
public class CadastroAdministrador extends javax.swing.JInternalFrame {
    ...
    private void restricoes() {
        ...
        if (campoNome.getText().trim().equals("")) {// Nome
    ...
    private void initComponents() {
        ...
        setTitle("Cadastrar Adminstrador");
